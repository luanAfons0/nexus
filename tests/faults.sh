...
fault_setup() {
  case "${NEXUS_FAULT:-}" in
    ...
    backup_copy_fail|backup_copy_false|backup_copy_corrupt|backup_root_corrupt|backup_child_corrupt|backup_symlink_corrupt) fault_save copy_agent_tree ;;
    backup_promote_second|backup_rollback|backup_final_corrupt) fault_save backup_move ;;
